            ...
            <div class="row">
                <div class="col-xs-12 col-lg-10 col-lg-offset-1" data-form-type="formoid">
                    ...
                    <form name="contactForm" action="#/" method="post" data-form-title="CONTACT FORM" >
                        ...
                        <div><button class="btn btn-primary" data-sitekey="6LcAOBAUAAAAANiMbmDDWopoGd4UAkYr6QLpgzTh"  data-callback="submitMessage()"><spring:message code="index.contact.submit" text="Submit"/></button></div>
